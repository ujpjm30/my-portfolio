...
import tinyMlImage from '../assets/images/tiny_ml.png';
...
const Projects = () => {
    ...
    const getLinkIcon = (linkKey) => {
        switch (linkKey) {
            case 'github':
                return <GitHubIcon sx={{ fontSize: 18, color: (theme) => theme.palette.mode === 'light' ? '#333' : '#fff' }} />;
            case 'pdf':
                return <PictureAsPdfIcon sx={{ fontSize: 18, color: (theme) => theme.palette.mode === 'light' ? '#333' : '#fff' }} />;
            case 'ppt':
                return <SlideshowIcon sx={{ fontSize: 18, color: (theme) => theme.palette.mode === 'light' ? '#333' : '#fff' }} />;
            default:
                return <LaunchIcon sx={{ fontSize: 18, color: (theme) => theme.palette.mode === 'light' ? '#333' : '#fff' }} />;
        }
    };
    ...
    const getThumbnailImage = (project) => {
        if (project.thumbnail === "/src/assets/images/tiny_ml.png") {
            return tinyMlImage;
        }
                        ...
                        return (
                            <Paper
                                ...
                                sx={{
                                    ...
                                    "&:hover": {
                                        transform: visibleCards.includes(index) ? 'translateY(-8px)' : 'translateY(30px)',
                            ...
                            >
                                ...
                                >
                                    {hasLinks && (
                                        ...
                                        >
                                            {Object.entries(projectLinks).map(([key, link], linkIndex) => (
                                                <Box
                                                    key={linkIndex}
                                                    ...
                                                    sx={{
                                                        ...
                                                        backgroundColor: (theme) => theme.palette.mode === 'light' 
                                                            ...
                                                            : 'rgba(0,0,0,0.7)',
                                                        border: (theme) => `1px solid ${theme.palette.mode === 'light' ? '#000' : '#fff'}`,
                                                        display: "flex",
                                                        alignItems: "center",
                                                        justifyContent: "center",
                                            ...
                                            <Chip 
                                                ...
                                                sx={{ 
                                                    backgroundColor: (theme) => theme.palette.mode === 'light' 
                                                        ? '#E5E7EB' 
                                                        : '#4B5563',
                                                    color: (theme) => theme.palette.mode === 'light' ? '#374151' : '#F9FAFB',
                                                    fontWeight: 500
                                                }} 
                                            />
                                        ))}
