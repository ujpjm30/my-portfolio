...
var SvgIcon = React4.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React4.isValidElement(children2) && children2.type === "svg";
  const ownerState = {
    ...props,
    color,
    component,
  ...
  return (0, import_jsx_runtime4.jsxs)(SvgIconRoot, {
    ...
    ownerState,
    children: [hasSvgAsChild ? children2.props.children : children2, titleAccess ? (0, import_jsx_runtime4.jsx)("title", {
...
var LazyRipple = class _LazyRipple {
  ...
  static use() {
    ...
    const [shouldMount, setShouldMount] = React11.useState(false);
    ripple.shouldMount = shouldMount;
    ripple.setShouldMount = setShouldMount;
    React11.useEffect(ripple.mountEffect, [shouldMount]);
    return ripple;
  }
  mount() {
    if (!this.mounted) {
...
TransitionGroup.propTypes = true ? {
   ...
   */
  childFactory: import_prop_types9.default.func
} : {};
...
ReplaceTransition.propTypes = true ? {
  in: import_prop_types10.default.bool.isRequired,
...
SwitchTransition.propTypes = true ? {
   ...
   * @type {'out-in'|'in-out'}
   */
  mode: import_prop_types11.default.oneOf([modes.in, modes.out]),
  /**
   * Any `Transition` or `CSSTransition` component.
   */
  children: import_prop_types11.default.oneOfType([import_prop_types11.default.element.isRequired])
} : {};
...
var TouchRipple = React20.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  return (0, import_jsx_runtime7.jsx)(TouchRippleRoot, {
...
var ButtonBase = React21.forwardRef(function ButtonBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsxs)(ButtonBaseRoot, {
    as: ComponentProp,
    className: clsx_default(classes.root, className),
    ownerState,
    onBlur: handleBlur,
    ...
    ...buttonProps,
    ...other,
    children: [children2, enableTouchRipple ? (0, import_jsx_runtime8.jsx)(TouchRipple_default, {
      ref: handleRippleRef,
      center: centerRipple,
      ...TouchRippleProps
    }) : null]
...
var CircularProgress = React22.forwardRef(function CircularProgress2(inProps, ref) {
  ...
  return (0, import_jsx_runtime9.jsx)(CircularProgressRoot, {
    className: clsx_default(classes.root, className),
    style: {
      width: size,
      height: size,
...
var Button = React25.forwardRef(function Button2(inProps, ref) {
  ...
  const startIcon = (startIconProp || loading && loadingPosition === "start") && (0, import_jsx_runtime10.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp || (0, import_jsx_runtime10.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  const endIcon = (endIconProp || loading && loadingPosition === "end") && (0, import_jsx_runtime10.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp || (0, import_jsx_runtime10.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  ...
  const loader = typeof loading === "boolean" ? (
    ...
    (0, import_jsx_runtime10.jsx)("span", {
      ...
      children: loading && (0, import_jsx_runtime10.jsx)(ButtonLoadingIndicator, {
...
true ? Button.propTypes = {
   ...
   * @default 'center'
   */
  loadingPosition: import_prop_types16.default.oneOf(["center", "end", "start"]),
  /**
   * The size of the component.
...
//# sourceMappingURL=chunk-RVPAVIAS.js.map
